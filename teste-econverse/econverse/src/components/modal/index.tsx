  ...
  return (
    <div className={`${styles.modal} ${isOpen ? styles.show : ''}`}>
      <div className={styles.modalContent}>
        ...
        <p className={styles.descriptionShort}>Many desktop publishing packages and web page editors<br></br> now many desktop publishing</p>
        <p className={styles.linkDetails}>Veja mais detalhes do produto &gt;</p>
