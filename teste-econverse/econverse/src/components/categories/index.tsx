...
export default function Categories() {
  ...
  // Função para importar os ícones de forma dinâmica
  const importIcons = async () => {
    const importedIcons: { [key: string]: string } = {
      tecnologia: (await import("/src/assets/images/tecnologia.svg")).default,
      supermercado: (await import("/src/assets/images/supermercado.svg")).default,
  ...
  const categories = [
    ...
    { key: "corrida", label: "Esportes e Fitness" },
    { key: "moda", label: "Moda" },
  ];
